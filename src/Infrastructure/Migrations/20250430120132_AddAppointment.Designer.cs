...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250430120132_AddAppointment")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Appointments.Appointment", b =>
                {
                    ...
                    b.Property<Guid?>("PatientCalendarEventId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("ProfessionalCalendarEventId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("PatientCalendarEventId");

                    b.HasIndex("ProfessionalCalendarEventId");

                    b.ToTable("appointment", "public");
                });

            modelBuilder.Entity("Domain.Entities.Associations.AppointmentAddress", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("appointment_address", "public");
                });
            ...
            modelBuilder.Entity("Domain.Entities.Appointments.Appointment", b =>
                {
                    b.HasOne("Domain.Entities.Associations.AppointmentAddress", "AppointmentAddress")
                        .WithMany()
                    ...
                    b.HasOne("Domain.Entities.Identities.User", "Patient")
                        .WithMany()
                        .HasForeignKey("PatientCalendarEventId");

                    b.HasOne("Domain.Entities.Identities.User", "Professional")
                        .WithMany()
                        .HasForeignKey("ProfessionalCalendarEventId");

                    b.OwnsOne("Domain.Entities.Appointments.AppointmentStatus", "Status", b1 =>
                        {
                            b1.Property<Guid>("AppointmentId")
                                .HasColumnType("uuid");

                            b1.Property<int>("AppointmentStatusEnum")
                                .HasColumnType("integer")
                                .HasColumnName("appointment_status");

                            b1.HasKey("AppointmentId");

                            b1.ToTable("appointment", "public");

                            b1.WithOwner()
                                .HasForeignKey("AppointmentId");
                        });

                    b.OwnsOne("Domain.Entities.Appointments.AppointmentType", "AppointmentType", b1 =>
                        {
                            b1.Property<Guid>("AppointmentId")
                                .HasColumnType("uuid");

                            b1.Property<int>("AppointmentTypeEnum")
                                .HasColumnType("integer")
            ...
            modelBuilder.Entity("Domain.Entities.Associations.AppointmentAddress", b =>
                {
                    b.HasOne("Domain.Entities.Addresses.Address", null)
                        .WithMany()
                        .HasForeignKey("AddressId")
                        .IsRequired();

                    b.HasOne("Domain.Entities.Appointments.Appointment", null)
                        .WithMany()
                        .HasForeignKey("AppointmentId")
                        .IsRequired();
                });
