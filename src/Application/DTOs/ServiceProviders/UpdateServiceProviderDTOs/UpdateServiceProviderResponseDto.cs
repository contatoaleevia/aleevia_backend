...
public record UpdateServiceProviderResponseDto
{
    public required UpdateServiceProviderData ServiceProvider { get; init; }

    public static UpdateServiceProviderResponseDto FromServiceProvider(ServiceProvider serviceProvider)
    {
        ArgumentNullException.ThrowIfNull(serviceProvider);

        return new UpdateServiceProviderResponseDto
        {
            ServiceProvider = new UpdateServiceProviderData
            {
...
public record UpdateServiceProviderData
{
